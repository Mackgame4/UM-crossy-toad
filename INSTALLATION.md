## Instalação / Bibliotecas necessárias
```bash
$ cabal update
...
```bash
$ git clone git@gitlab.com:uminho-di/li1/2223/2022li1g009.git
$ cd 2022li1g009
```
...
```bash
$ git clone https://gitlab.com/uminho-di/li1/2223/projetos/2022li1g009.git
$ cd 2022li1g009
```
...
Pode dar build do jogo através do compiler Haskell:

1. Usando o GHC
```bash
$ ghc -outputdir "./build" -o "./build/Main" -i="src" -i="tests" src/Main.hs
```

ou, para obter um .exe:
```bash
$ ghc -outputdir "./build" -o "./build/Main.exe" -i="src" -i="tests" src/Main.hs
```
...
ou utilizando o `dark theme` customizado:

```bash
$ haddock -h -o doc/html src/*.hs --theme=doc/theme
```